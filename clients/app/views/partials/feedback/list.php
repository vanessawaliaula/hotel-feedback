                ...
                <div class="row ">
                    ...
                    <div class="col-md-2 comp-grid">
                        <form method="get" action="<?php print_link($current_page) ?>" class="form filter-form">
                            <div class="card mb-3">
                                <div class="card-header h4 h4">Branch</div>
                                <div class="p-2">
                                    <select   name="feedback_hotel_branch" class="form-control custom ">
                                        <option value="">Select branch ...</option>
                                        <?php 
                                        $feedback_hotel_branch_options = $comp_model -> feedback_feedbackhotel_branch_option_list();
                                        if(!empty($feedback_hotel_branch_options)){
                                        foreach($feedback_hotel_branch_options as $option){
                                        $value = (!empty($option['value']) ? $option['value'] : null);
                                        $label = (!empty($option['label']) ? $option['label'] : $value);
                                        $selected = $this->set_field_selected('feedback_hotel_branch',$value);
                                        ?>
                        ...
                        <div class="col-md-10 comp-grid">
                            ...
                            <div class="filter-tags mb-2">
                                <?php
                                if(!empty(get_value('feedback_hotel_branch'))){
                                ?>
                                <div class="filter-chip card bg-light">
                                    <b>Hotel Branch :</b> 
                                    <?php 
                                    if(get_value('feedback_hotel_branchlabel')){
                                    echo get_value('feedback_hotel_branchlabel');
                                    }
                                    else{
                                    echo get_value('feedback_hotel_branch');
                                    }
                                    $remove_link = unset_get_value('feedback_hotel_branch', $this->route->page_url);
                                    ?>
