...
class SharedController extends BaseController{
	...
	/**
     * feedback_feedbackhotel_branch_option_list Model Action
     * @return array
     */
	function feedback_feedbackhotel_branch_option_list(){
		$db = $this->GetModel();
		$sqltext = "SELECT  DISTINCT branch AS value,branch AS label FROM branches ORDER BY branch";
		$queryparams = null;
		$arr = $db->rawQuery($sqltext, $queryparams);
		return $arr;
	}
